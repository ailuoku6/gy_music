...
class DownSong extends Component {
    constructor() {
        super();
        this.state = {
            songs:[],
        ...
        return (
            <View style={styles.container}>
                ...
                <Button onPress={()=>{
                    ...
                    if (!judgeValue(this.state.songId)) {
                    ...
                    DataBaseModule.DownSong(this.state.songId).then((result)=>{
                        if (result==='succ'){
...
export default connect(mapStateToProps)(DownSong);
